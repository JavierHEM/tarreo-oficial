-- Script para recrear completamente la tabla team_invitations
-- Ejecutar en Supabase SQL Editor

-- 1. Eliminar tabla existente si existe
DROP TABLE IF EXISTS public.team_invitations CASCADE;

-- 2. Crear tabla de invitaciones de equipo desde cero
...
CREATE INDEX team_invitations_inviter_idx ON public.team_invitations(inviter_id);
CREATE INDEX team_invitations_invitee_idx ON public.team_invitations(invitee_id);
...
-- 7. Función para crear invitación desde mensaje de contacto
...
-- 8. Función para aceptar invitación de equipo
...
-- 9. Función para obtener invitaciones de un usuario
